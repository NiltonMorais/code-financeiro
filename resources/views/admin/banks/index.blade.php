                    ...
                    <tr>
                        <td>
                            <div class="row valign-wrapper">
                                <div class="col s12">{{$item->id}}</div>
                            </div>
                        </td>
                        <td>
                            <div class="row valign-wrapper">
                                <div class="col s2">
                                    <img src="{{asset($item->logo_path)}}" class="bank-logo">
                                </div>
                                <div class="col s10">
                        ...
                        <td>
                            <div class="row valign-wrapper">
                                <div class="col s12">
                                    ...
                                    <delete-action action="{{route('admin.banks.destroy',['bank'=>$item->id])}}"
                                                   action-element="link-delete-{{$item->id}}"
                                        ...
                                        <modal :modal="{{json_encode(['id'=>$modalId])}}" style="display: none">
                                            ...
                                            <div slot="footer">
                                                <button id="link-delete-{{$item->id}}"
                                                        class="btn btn-flat waves-effect green lighten-2 modal-close modal-action">
                                                    Ok
                                                </button>
