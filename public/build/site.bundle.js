...
/***/ function(module, exports, __webpack_require__) {
	...
	Vue.component('site-menu', __webpack_require__(75));
	Vue.component('subscription-create', __webpack_require__(78));
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	  ...
	  console.warn("[vue-loader] resources\\assets\\site\\js\\components\\SiteMenu.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  var id = "_v-4fe85470/SiteMenu.vue"
	  if (!module.hot.data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] resources\\assets\\site\\js\\components\\SubscriptionCreate.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-cc07b8ba/SubscriptionCreate.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
	    ...
	    methods: {
	        submit: function submit() {
	            if (this.payment_type == 'credit_card') {
	                var expirationArray = this.credit_card.expiration.split('/');
	                var creditCard = Iugu.CreditCard(this.credit_card.number, expirationArray[0], expirationArray[1], this.credit_card.first_name, this.credit_card.last_name, this.credit_card.cvv);
